...
const buildHtml = (version: string): string => {
	...
	return [
		...
		'<meta name="generator" content="ai-meeting watch">',
		`<meta name="ai-meeting-version" content="${versionAttr}">`,
		"<title>ai-meeting · live</title>",
		...
		'<div id="app">',
		'<header class="topbar">',
		'<span class="brand">ai-meeting · live</span>',
